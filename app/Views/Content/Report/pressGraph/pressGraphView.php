<style type="text/css">
    ...
    <!--- DATA GRID ------------------------------------------------------------------------->
    <table id="dg" title="" class="easyui-datagrid"  style="<?php  echo $tinggi_dg ; ?>"  url="<?php echo site_url() . '/../Content/Report/pressGraph/dataList'; ?>" toolbar="#tb-pv" data-options="striped:true,
                    fitColumns:false,
                    pagination:true,
                    pageSize:50,
                    showFooter: true,
    ...
    <script type="text/javascript">
        ...
        function exportDataExcel() {
            ...
            var url = "<?php  echo site_url() . '/../Content/Report/pressGraph/exportExcelFile?TDATE='; ?>"+dateParam+"&DT_DIV="+dtDivParam;
        ...
        function exportDataPDF() {
            ...
            var url = "<?php  echo site_url() . '/../Content/Report/pressGraph/exportPDFFile?TDATE='; ?>"+dateParam+"&DT_DIV="+dtDivParam;
            window.open(url, "_blank");
    }
