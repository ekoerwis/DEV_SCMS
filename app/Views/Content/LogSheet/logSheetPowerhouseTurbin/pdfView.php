    ...
    <table id="dataTable" class="table1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="tdTable1" ><?= number_format($data_sql[$i]['SDTTMP4'],2,".",",") ?></td>
                <td class="tdTable1" ><?= number_format($data_sql[$i]['SDTTMP5'],2,".",",") ?></td>
                <td class="tdTable1" ><?= number_format($data_sql[$i]['SDTTMP6'],2,".",",") ?></td>
            </tr>
<?php
