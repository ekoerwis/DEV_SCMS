...
class logSheetSterilizerModel extends \App\Models\BaseModel
{
    ...
    public function reportSqlString($tdate='' ,$dt_div=''){
        ...
        THEN
        ROUND((  TO_DATE(TO_CHAR(STZIN_ED,'DD/MON/YYYY HH24:MI')||':00'  ,'DD/MON/YYYY HH24:MI:SS') - TO_DATE(TO_CHAR(STZIN_ST,'DD/MON/YYYY HH24:MI')||':00'  ,'DD/MON/YYYY HH24:MI:SS')) * 24 * 60 )
        ELSE 0 END STZIN_MN_2,
        ...
        THEN
        ROUND((  TO_DATE(TO_CHAR(STZPRO_ED,'DD/MON/YYYY HH24:MI')||':00'  ,'DD/MON/YYYY HH24:MI:SS') - TO_DATE(TO_CHAR(STZPRO_ST,'DD/MON/YYYY HH24:MI')||':00'  ,'DD/MON/YYYY HH24:MI:SS')) * 24 * 60 )
        ELSE 0 END STZPRO_MN_2,
        ...
        THEN
        ROUND((  TO_DATE(TO_CHAR(STZOUT_ED,'DD/MON/YYYY HH24:MI')||':00'  ,'DD/MON/YYYY HH24:MI:SS') - TO_DATE(TO_CHAR(STZOUT_ST,'DD/MON/YYYY HH24:MI')||':00'  ,'DD/MON/YYYY HH24:MI:SS')) * 24 * 60 )
        ELSE 0 END STZOUT_MN_2,
        STZTM_TOT, 
        CASE 
        WHEN STZIN_ST IS NOT NULL AND STZIN_ED IS NOT NULL
        THEN
        ...
        THEN
        ROUND((  TO_DATE(TO_CHAR(STZOUT_ED,'DD/MON/YYYY HH24:MI')||':00'  ,'DD/MON/YYYY HH24:MI:SS') - TO_DATE(TO_CHAR(STZOUT_ST,'DD/MON/YYYY HH24:MI')||':00'  ,'DD/MON/YYYY HH24:MI:SS')) * 24 * 60 )
        ELSE 0 END STZTM_TOT_2, 
        STZACC, STZNOTE FROM POM_LGS_STZ WHERE  ROWNUM > 0 AND STZTM_TOT > 0 $w_tdate $w_dt_div
        ";
