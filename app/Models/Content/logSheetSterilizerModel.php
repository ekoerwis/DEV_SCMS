...
class logSheetSterilizerModel extends \App\Models\BaseModel
{
    ...
    public function reportSqlString($tdate='' ,$dt_div=''){
        ...
        TO_DATE( TO_CHAR(FROM_TZ( CAST( (TO_DATE('19700101', 'YYYYMMDD') + ( 1 / 24 / 60 / 60 / 1000) * UEP) AS TIMESTAMP ), 'UTC' ) AT TIME ZONE '+07:00','YYYY-MM-DD HH24:MI:SS') , 'YYYY-MM-DD HH24:MI:SS') TDATE_UEP_DATEF,
        TO_CHAR(FROM_TZ( CAST( (TO_DATE('19700101', 'YYYYMMDD') + ( 1 / 24 / 60 / 60 / 1000) * UEP) AS TIMESTAMP ), 'UTC' ) AT TIME ZONE '+07:00','DD/MON/YYYY HH24:MI:SS')  TDATE_UEP, 
